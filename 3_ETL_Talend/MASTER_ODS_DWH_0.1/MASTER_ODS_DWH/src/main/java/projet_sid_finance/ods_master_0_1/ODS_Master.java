...
package projet_sid_finance.ods_master_0_1;
...
/**
 * Job: ODS_Master Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class ODS_Master implements TalendJob {
...
public String getROOT_PROJECT(){
	...
	private final String jobName = "ODS_Master";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ODS_Master.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    final static byte[] commonByteArrayLock_PROJET_SID_FINANCE_ODS_Master = new byte[0];
    static byte[] commonByteArray_PROJET_SID_FINANCE_ODS_Master = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PROJET_SID_FINANCE_ODS_Master) {
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		projet_sid_finance.load_staging_clients_0_1.Load_Staging_Clients childJob_tRunJob_1 = new projet_sid_finance.load_staging_clients_0_1.Load_Staging_Clients();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		projet_sid_finance.load_staging_client_compte_0_1.Load_Staging_Client_Compte childJob_tRunJob_2 = new projet_sid_finance.load_staging_client_compte_0_1.Load_Staging_Client_Compte();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		projet_sid_finance.load_staging_foyers_0_1.Load_Staging_Foyers childJob_tRunJob_3 = new projet_sid_finance.load_staging_foyers_0_1.Load_Staging_Foyers();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final ODS_Master ODS_MasterClass = new ODS_Master();

        int exitCode = ODS_MasterClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ODS_Master.class.getClassLoader().getResourceAsStream("projet_sid_finance/ods_master_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = ODS_Master.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ODS_Master");
        }
...
/************************************************************************************************
 *     44326 characters generated by Talend Open Studio for Data Integration 
